...
Once a player is hired, the will receive a special document (a "hire document") in which the player can find the required work hours per day for that job. This is the amount of in-game hours the player must spend in the place of work per day in order to stay employeed. If the player misses 24 work hours after any given period of time, they will be terminated. Players will received their respective salary (specified in the hire document) everyday after completing their work hours, however they wont be paid unless they complete the task specified in the job description of their job on at least 3 separate ocasions before their daily work hours are completed. The player's pay will decrease depending on the amount of work hours they miss on a given day.

### Currency and Banking
  The in-game society runs on a currency (dollars) which each player is designated a certain amount of (5000) at conception. Each player has the ability to sell objects to other players through a personal store, in which they can display some of their belongings to be viewed and bought by other players. Players can also earn money by applying to a job and complying with it's nesessary requirments. Players by default have no bank account, and must go to the bank and speak with the designated NPSs at the front desk. The player will have to fill out an application form, after which they will have a designated bank account and the corresponding documentation such as the PIN number for the account and a debit card. Players can manage their money by going to the bank and speaking with the designated NPSs at the front desk or accessing the bank ATMs. At these points the player will have to provide their PIN number, which can be found in the player's documentation. They can then preform actions with their account which are listed below.
