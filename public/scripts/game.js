...
const enemySpawnLoop = new LoopAnimation(function() {
  if ($MAP.avatarCount < 5) {
   let {
      ...
      a = new Bot("ENEMY [KILL BOT]", x + 5, y - 5);
      $MAP.link(a);
...
$MAP.link(new AssassinsKnife(40,0));
/*
