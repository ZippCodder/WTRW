// misc helper functions and key classes
 ...
 export function cut(ar, lw=0, atrbs=[], vertices=false) {
        ...
        for (let i of ar) {
            ...
            res.push(...[[x, y,...atrbs], [x+w, y,...atrbs], [x, y+h,...atrbs],

                [x+w, y,...atrbs], [x, y+h,...atrbs], [x+w, y+h,...atrbs]]);
    ...
    function cut(ar, lw) {
        ...
        for (let i = 0; i < ar.length; i++) {
            ...
            res.push(...[[x, y], [x+w, y], [x, y+h],
                ...
                letterRes.push(...[[lx, ly], [lx+lw, ly], [lx, ly+lh],

                [lx+lw, ly], [lx, ly+lh], [lx+lw, ly+lh]]);
        }
...
// Animation creation objects
 ...
 export class LoopAnimation {
        ...
        function assessObstacles(x,y,dimensions,obstacles) {
            let move = {x: x, y: y};
            let {x: ax, y: ay, width: aw, height: ah} = dimensions;
