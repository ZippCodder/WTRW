    ...
    class Avatar {
        ...
        postLink() {
            ...
            this.state.fireAnimation = new LoopAnimation(function() {
                ...
                map.link(new Bullet(nx + this.trans.offsetX, ny + this.trans.offsetY, ((this.trans.rotation) * 180 / Math.PI) + 90, (x) * this.state.equippedItems.mainTool.constructor._properties.bulletSpeed, (y) * this.state.equippedItems.mainTool.constructor._properties.bulletSpeed, this.state.equippedItems.mainTool.constructor._properties.damage, this.id));
        ...
        hit(damage, x, y, owner) {
            if (!this.state.invinsible) {
                ...
                if (this.state.vitals.health <= 0) {
                    let a = (this.map ?? $CURRENT_MAP).avatars[owner];
