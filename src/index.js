    ...
    */
    ...
    window.onload = () => {
        ...
        let scale = 1.2;
        let joystickSizes = {left: 1.5, right: 1.5};
        ...
        class _BulletClusterClient_ {
            ...
            constructor(initialX = 0,initialY = 0, initialRotation = 0, translationX = 0, translationY = 0, damage = 1) {
              this.trans = {
                ...
                this.rate = {x: translationX, y: translationY};
                this.damage = damage;
            }
        ...
        /* Misc props */
         ...
         class RoadRail extends _InstancedClusterClient_ {
              ...
              name = "road rail";
              obstacle = true;
              segments = [[-13.2,-5.7,3.4,11.4],[9.8,-5.7,3.4,11.4],[-10.2,-4.7,20.4,8.6]];
        ...
        class UrbanFenceHalf extends _StaticClusterClient_ {
         ...
         class PicnicTable extends _StaticClusterClient_ {
              ...
              segments = [[-14.2,-6.3,8.4,18.4],[-6.2,-8.7,12.4,20.4],[5.8,-6.3,8.4,18.4]];
              interactable = true;
              minDistance = 20;
        ...
        class RoadTriCorner extends _StaticClusterClient_ {
         ...
         class _Building_ extends _StaticClusterClient_ {
           constructor(initialX,initialY,initialRotation, doors=[],rooms) {
               ...
               this.doors = [];
               this.rooms = rooms || [new _Map_(150,80,false).init([[0,35]])];
         ...
         class GenericApartment extends _Building_ {
              ...
              obstacle = true;
              segments = [[-32.2,-23,64.4,30.4],[-30.2,7,60.4,14.4]];
              
            constructor(initialX,initialY, initialRotation) {
                super(initialX,initialY,initialRotation,[[19,-20,0]]);
            }
        }
        ...
        class Cafe extends _Building_ {
              ...
              obstacle = true;
              segments = [[-40.2,-30.2,80.4,42.4],[-38.2,9.8,76.4,20.4]];
              
            constructor(initialX,initialY, initialRotation) {
                super(initialX,initialY,initialRotation,[[20,20,0]]);
            }
        }
         ...
         class Supermarket extends _StaticClusterClient_ {
              ...
              obstacle = true;
              segments = [[-62.2,-26.2,124.4,34.4],[-60.2,7.8,120.4,18.4]];
        ...
        class USP_45 extends _Gun_ {
         ...
         class PickupRing extends _InstancedClusterClient_ {
            ...
            constructor(name="Unnamed Human",initialX=0, initialY=0, initialRotation=0) {
                ...
                this.state = {
                    ...
                    gotoAnimation: new LoopAnimation(function(){
                        ...
                        tx = (Math.abs(this.state.goto.x - this.trans.offsetX) < this.state.goto.movementFactor) ? (this.state.goto.x - this.trans.offsetX):(this.trans.offsetX < this.state.goto.x) ? this.state.goto.movementFactor:-this.state.goto.movementFactor;
                        }
                        
                        if (this.state.goto.y !== this.trans.offsetY) {
                        ty = (Math.abs(this.state.goto.y - this.trans.offsetY) < this.state.goto.movementFactor) ? (this.state.goto.y - this.trans.offsetY):(this.trans.offsetY < this.state.goto.y) ? this.state.goto.movementFactor:-this.state.goto.movementFactor;
                        }
            ...
            preRender() {
                ...
                if (this.vitals.health < 0) this.delete();
            }
            ...
            deleteRecording() {
                ...
                this.state.goto.target = {x: 0, y: 0};
            ...
            goto(x,y) {
                ...
                this.state.goto.target = {x: x, y: y};
        ...
        // class for visible barriers
            ...
            constructor(initialX, initialY, width, height,color=[40,40,40,1.0]) {
                super([], function() {
                    ...
                    this.vertices = cut([[-width/2,-height/2,width,height]],false,[1],true);
                    this.width = width;
                    this.height = height;
                    this.color = color;
                ...
                this.segments = [[-width/2,-height/2,width,height]];
                this.obstacle = true;
        ...
        class _Map_ {
            ...
            static _recording = {isRecording: false, recording: []};
            ...
            constructor(width, height, root=true) {
                ...
                this.darkness = 1;
                this.units = {width: width/10, height: height/10, total: (width/10)*(height/10)};
                this.objects = {};
                this.obstacles = {};
                this.locations = {};
                this.clusters = {};
            ...
            locateObject(name) {
                let closest = 1000, result, currentDistance;
            ...
            printLayoutScript(json=true,resetTranslation,start = 0) {
                ...
                let objs = {layout: [], settings: {groundColor: this.groundColor, lighting: this.lighting, darkness: this.darkness}, root: this.root, nodes: this.SUB_MAP_COUNT, children: []};
                ...
                let frame = [ob.constructor.name];
                   ...
                   // add special attributes for more complex objects...
                    switch(ob.name) {
                        case "avatar": frame = frame.concat([ob.character,ob.trans.offsetX,ob.trans.offsetY,ob.trans.rotation*(180/Math.PI)]);
                        break;
                        case "text": frame = frame.concat([ob.text,ob.size,ob.color,ob.trans.offsetX,ob.trans.offsetY,ob.trans.rotation*(180/Math.PI),false]);
                        break;
                        case "door": frame = frame.concat([ob.text,ob.roomIndex,ob.trans.offsetX,ob.trans.offsetY,ob.trans.rotation*(180/Math.PI)]);
                        break;
                        case "visible barrier": frame = frame.concat([ob.trans.offsetX,ob.trans.offsetY,ob.width,ob.height,ob.color]);
                        break;
                        default: frame = frame.concat([ob.trans.offsetX,ob.trans.offsetY,ob.trans.rotation]);
                        break;
                    }
            ...
            parseLayoutScript(layout,json=true) {
                ...
                let objs = objects.layout, children = objects.children, settings = objects.settings;
        ...
        let _MAP_ = new _Map_(100,100).init();
        $CURRENT_MAP = _MAP_;
        _MAP_.showGeometry();
      ...
      let transitionAnimation = new LoopAnimation(function(){
            ...
            if (globalDarkness === points[phase] && phase === 1) {
                ...
                if (Math.abs(globalDarkness-points[phase])<0.01 || (globalDarkness > points[phase] && phase === 0)) { globalDarkness = points[phase];
                }
            },undefined,0.005);
        ...
        */
        ...
        canvas.addEventListener("touchend", (e) => {
            ...
            let ids = Object.values(e.touches).reduce((a,v) => {a.push(v.identifier)},[]);
        ...
        function enableConsole() {
            let comms = [], commIndex, inputs = [], addedObjects = [];
