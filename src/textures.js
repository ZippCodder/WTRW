...
const _PROPERTIES_ = {
    ...
    pickup: { size: 10 },
    prop: { size: 10 },
    control: { size: 35 }, // joysticks: 20, buttons: 35
    general: { size: 10 },
    text: {size: 1}
}
...
export let JOYSTICK_DISC_TEXTURE = new TextureData(0,0,1,"general",{width: 700, height: 700},[[0,0,700,700]],0,undefined,function (ctx) {
...
export let PICKUP_RING = new TextureData(0,0,0.2,"general",{width: 428, height: 428},[[0,0,428,428]],0,undefined,function (ctx) {
        // base body: 600x600, texture: 1024x1024, size: 20
...
export let ACTION_BUTTON_TEXTURE = new TextureData(0,0,1,"control",{width: 600, height: 600},[[0,0,600,600]],0,undefined,function (ctx) {
        // base body: 600x600, texture: 1024x1024, size: 20
        ctx.scale(this.size || 0, this.size || 0);
...
export let HIT_TEXT = new TextureData(0,0,1,"general",{width: 700, height: 700},[[0,0,700,700]],0,undefined,function (ctx) {
        // base body: 600x600, texture: 1024x1024, size: 20
...
export let ICONS = new TextureData(0,0,1,"control",{width: 600, height: 600},[[0,0,600,600]],0,undefined,function (ctx) {
        // base body: 600x600, texture: 1024x1024, size: 20
...
export let NXR_44_MAG = new TextureData(-2,-7,0.2,"firearm",{width: 691, height: 344},[[0,0,691,344]],0,undefined,function (ctx) {
    // -2 -7
            ctx.save();
            ctx.translate(this.offset.x, this.offset.y);
            ctx.scale(this.size || 0, this.size || 0);
...
export let GP_K100 = new TextureData(-8,-20,0.2,"firearm",{width: 740, height: 309},[[0,0,740,309]],0,undefined,function (ctx) {
...
export let USP_45 = new TextureData(-8,-5,0.2,"firearm",{width: 815, height: 393},[[0,0,815,393]],0,undefined,function (ctx) {
...
export let KC_357 = new TextureData(1,-30,0.2,"firearm",{width: 426, height: 280},[[0,0,426,280]],0,undefined,function (ctx) {
...
export let GLOCK_20 = new TextureData(0,30,0.2,"firearm",{width: 439, height: 309},[[0,0,439,309]],0,undefined,function (ctx) {
...
export let MAIN_AVATAR_DEFAULT = new TextureData(-1,-1,0.2,"avatar",{width: 702, height: 428},[[152, 15, 408, 408]],0,undefined,function (ctx) {
...
export let MAIN_AVATAR_DRAW_WEAPON = new TextureData(-1,-1,0.2,"avatar",{width: 702, height: 2140},[[0, 0, 702, 2140]],0,undefined,function (ctx) {
  ...
  let h1 = {x: -272, y: 590}; // -272, -110
  let h2 = {x: 150, y: 575}; // 150, -125
  let b = {x: 0, y: 856}; // 0, 156
...
export let GLOCK_20_TOP = new TextureData(54,182,0.2,"firearm",{width: 900, height: 200},[[0,0,900,200]],0,undefined,function (ctx,r=0) {
      // body: 439x309, texture: 1024,512, size: 0.15
      // -8 -20
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
...
export let GLOCK_20_TOP_2 = new TextureData(54,182,0.2,"firearm",{width: 900, height: 200},[[0,0,900,200]],0,undefined,function (ctx,r=0) {
      // body: 439x309, texture: 1024,512, size: 0.15
      // -8 -20
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
...
export let DOOR = new TextureData(0,0,0.2,"pickup",{width: 730, height: 1020},[[0,0,730,1020]],0,undefined,function (ctx) {
    // -12, -4
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let TABLE = new TextureData(2,2,0.2,"avatar",{width: 1400, height: 910},[[0,0,1400,800],[40,800,100,110,0],[1260,800,100,110,0]],20,undefined,function (ctx) {
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let BOOK_1 = new TextureData(3,2,0.2,"pickup",{width: 301, height: 416},[[0,0,301,416]],0,undefined,function (ctx) {
    // 3,2
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let BOOK_2 = new TextureData(3,2,0.2,"pickup",{width: 301, height: 416},[[0,0,301,416]],0,undefined,function (ctx) {
    // 3,2
          ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let KITCHEN_KNIFE = new TextureData(4,2,0.2,"pickup",{width: 124, height: 657},[[0,0,124,657]],0,undefined,function (ctx) {
    // 4 2 
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let ASSASSINS_KNIFE = new TextureData(8,4,0.2,"pickup",{width: 173, height: 677},[[0,0,173,677]],0,undefined,function (ctx) {
    // 8 4 
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let COMBAT_KNIFE = new TextureData(27,27,0.2,"pickup",{width: 349, height: 463},[[0,0,349,463]],0,undefined,function (ctx) {
    // 27 27 
   ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let LAPTOP = new TextureData(1,-9,0.2,"pickup",{width: 436, height: 486},[[0,0,436,486]],0,undefined,function (ctx) {
    // 1 -9
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let ROAD = new TextureData(0,0,0.2,"prop",{width: 2500, height: 1410},[[0,0,2500,1410]],0,undefined,function (ctx) {
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROAD_DOUBLE = new TextureData(0,0,0.2,"prop",{width: 2500, height: 1410},[[0,0,2500,1410]],0,undefined,function (ctx) {
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROAD_CORNER = new TextureData(0,0,0.2,"prop",{width: 1410, height: 1410},[[0,0,1410,1410]],0,undefined,function (ctx) {
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROAD_TRICORNER = new TextureData(0,0,0.2,"prop",{width: 1410, height: 1410},[[0,0,1410,1410]],0,undefined,function (ctx) {
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROAD_QUADCORNER = new TextureData(0,0,0.2,"prop",{width: 1410, height: 1410},[[0,0,1410,1410]],0,undefined,function (ctx) {
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let BULLET = new TextureData(0,0,0.2,"prop",{width: 90, height: 40},[[0,0,90,40]],0,undefined,function (ctx) {
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let BULLETSHELL = new TextureData(0,0,0.2,"prop",{width: 90, height: 50},[[0,0,90,50]],0,undefined,function (ctx) {
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROAD_SIGN =  new TextureData(2,2,0.2,"prop",{width: 380, height: 1520},[[0,0,380,520],[160,520,60,1000]],20,undefined,function (ctx) {
    ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let PICNIC_TABLE = new TextureData(2,-8,0.2,"prop",{width: 1400, height: 850},[[0,170,400,900],[400,50,600,1000],[1000,170,400,900],[300,1050,800,200,0]],20,undefined,function (ctx) {
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let DOUBLE_CROSS_TILE = new TextureData(1,1,0.2,"prop",{width: 1000, height: 1000},[[0,0,1000,1000]],10,undefined,function (ctx) {
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let URBAN_FENCE = new TextureData(0,0,0.2,"prop",{width: 2420, height: 1420},[[0,0,2420,1420]],0,undefined,function (ctx) {
    // 2, 2
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let URBAN_FENCE_VERTICAL = new TextureData(0,0,0.2,"prop",{width: 220, height: 2820},[[0,0,220,2820]],0,undefined,function (ctx) {
    // 2, 2
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let URBAN_FENCE_HALF = new TextureData(0,0,0.2,"prop",{width: 1220, height: 1420},[[0,0,1220,1420]],0,undefined,function (ctx) {
    // 2, 2
  ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let SMALL_PLANT =  new TextureData(2,17,0.2,"prop",{width: 250, height: 780},[[0,300,250,400],[0,-80,250,380,0]],20,undefined,function (ctx) {
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let TILE = new TextureData(2,2,0.2,"prop",{width: 400, height: 400},[[0,0,400,400]],20,undefined,function (ctx) {
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let LIGHT_SWITCH = new TextureData(2,2,0.2,"prop",{width: 160, height: 240},[[0,0,160,240]],0,undefined,function (ctx) {
    // 2,2
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let STREET_LIGHT = new TextureData(146,-38,0.2,"prop",{width: 1550, height: 2450},[[0,0,1550,2450]],0,undefined,function (ctx) {
    // 146, -38
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let GRASS_1 = new TextureData(0,0,0.2,"prop",{width: 150, height: 150},[[0,0,150,150]],0,undefined,function (ctx) {
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let GRASS_2 = new TextureData(0,0,0.2,"prop",{width: 150, height: 150},[[0,0,150,150]],0,undefined,function (ctx) {
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROCKS_1 = new TextureData(0,0,0.2,"prop",{width: 150, height: 150},[[0,0,150,150]],0,undefined,function (ctx) {
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROCKS_2 = new TextureData(0,0,0.2,"prop",{width: 150, height: 150},[[0,0,150,150]],0,undefined,function (ctx) {
      ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let CHAIR = new TextureData(0,0,0.2,"prop",{width: 520, height: 750},[[0,0,520,680]],0,undefined,function (ctx) {
    // 2, -10
           ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let BENCH = new TextureData(2,-10,0.2,"prop",{width: 1220, height: 770},[[0,0,1220,670]],0,undefined,function (ctx) {
    // 2, -10
           ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
...
export let ROAD_RAIL = new TextureData(-58,-18,0.2,"prop",{width: 1300, height: 550},[[300,100,150,550],[1450,100,150,550],[450,150,1000,410]],20,undefined,function (ctx) {
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
...
export let ROAD_RAIL_VERTICAL = new TextureData(-58,-18,0.2,"prop",{width: 150, height: 1250},[[300,100,150,1250]],20,undefined,function (ctx) {
     ctx.save();
  ctx.translate(this.offset.x, this.offset.y);
  ctx.scale(this.size, this.size);
  ctx.beginPath();
